 ...
 */
final class Version20230417065324 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE annonce (id INT AUTO_INCREMENT NOT NULL, membre_id INT NOT NULL, date_creation DATETIME NOT NULL, code_postal VARCHAR(25) NOT NULL, ville VARCHAR(100) NOT NULL, nom_proprietaire VARCHAR(255) NOT NULL, prenom_proprietaire VARCHAR(200) NOT NULL, telephone VARCHAR(20) DEFAULT NULL, nom_animal VARCHAR(200) NOT NULL, description LONGTEXT DEFAULT NULL, adresse_mail VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) NOT NULL, category VARCHAR(100) NOT NULL, espece VARCHAR(50) NOT NULL, age_animal INT NOT NULL, sexe_animal VARCHAR(150) NOT NULL, puce VARCHAR(100) NOT NULL, tatoue VARCHAR(100) NOT NULL, taille_poil VARCHAR(100) NOT NULL, dessin_poil VARCHAR(100) NOT NULL, couleur_poil JSON NOT NULL, INDEX IDX_F65593E56A99F74A (membre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE membre (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, is_verified TINYINT(1) NOT NULL, pseudonyme VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_F6B4FB29E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
